 ...
 * Generated at: 2024-10-17 01:27:39 UTC
...
try{
   ...
   try{
      ...
      out.write("<table>\r\n");
      out.write("   <thead>\r\n");
      out.write("   <th><input  type=\"checkbox\" id=\"ckbAll\" name=\"ckbAll\">전체선택</th>\r\n");
      ...
      out.write("\" id=\"ckb_");
      out.print( evo.getEmpno() );
      out.write("\" name=\"ckb_\" value=\"ckb_\"></td>\r\n");
      out.write("         <td>");
      out.print( evo.getEmpno() );
      out.write("</td>\r\n");
      out.write("         <td>");
      ...
      out.write("  	$(\"#ckbAll\").on(\"click\", function () {\r\n");
      ...
      out.write("  \r\n");
      out.write("  <script>\r\n");
      out.write("  	// 각 사원들의 체크박스를 클릭할때 모두선택 체크박스 처리\r\n");
      out.write("  	$(\"table tbody tr\").find(\"td:first-child :checkbox\").on(\"click\", function () {\r\n");
      ...
      out.write("  \r\n");
      out.write("  <script>\r\n");
      out.write("  // 2. 클라이언트에서 selected를 추가하는 방법\r\n");
      out.write("  // ?deptno=30\r\n");
      out.write("  ");
      out.write("\r\n");
      ...
      out.write("  // 1번 풀이\r\n");
      out.write("  /*\r\n");
      out.write("  $(\"tfoot button\").on(\"click\", function() {\r\n");
      out.write("	     let empnos = [];\r\n");
      out.write("	     $(\"tbody :checkbox:checked\").each(function(i,elem){\r\n");
      out.write("	        // ck       td               다음td\r\n");
      out.write("	        let empno = elem.parentElement.nextElementSibling.innerText;\r\n");
      ...
      out.write("		let empnos = [];\r\n");
      out.write("		$(\"tbody :checkbox:checked\").each(function(i,elem){\r\n");
      out.write("	        // jQuery method : data() 	data-empno \r\n");
      out.write("	        // 이러면 그놈 속성값을 가져오게 됨\r\n");
      out.write("	        let empno = $(elem).data(\"empno\")\r\n");
      out.write("	        empnos.push(empno);\r\n");
      out.write("	        \r\n");
      out.write("	     });\r\n");
